    ...
    internal class StreamReadBuffer : IDisposable
    {
        ...
        public StreamReadBuffer(Stream source, bool minimalRead)
        {
            ...
            lock(_lockObjects)
            {
                ...
                {
                    _lockObjects.Add(source, new StreamWrapper(source));
        ...
        void SaveBuffer()
        {
            _savedBuffers.Add(new SavedBuffer(_data, _baseOffset, _end, _discardCount, _versionCounter));
        ...
        class StreamWrapper
        {
            ...
            public long EoFOffset = long.MaxValue;
        ...
        class SavedBuffer
        {
            ...
            public SavedBuffer(byte[] buffer, long baseOffset, int end, int discardCount, long versionSaved)
            {
                Buffer = buffer;
